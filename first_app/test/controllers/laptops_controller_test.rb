...
class LaptopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laptop" do
    assert_difference('Laptop.count') do
      post laptops_url, params: { laptop: { company: @laptop.company, inch: @laptop.inch, year: @laptop.year } }
    end
  ...
  test "should update laptop" do
    patch laptop_url(@laptop), params: { laptop: { company: @laptop.company, inch: @laptop.inch, year: @laptop.year } }
